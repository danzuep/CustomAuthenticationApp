...
public class DimensionService : IDimensionService
{
    ...
    private readonly DimensionChangeOptions _options;

    public DimensionService(IJSRuntime jsRuntime, IOptions<DimensionChangeOptions>? options = null)
    {
        _jsInterop = jsRuntime;
        _options = options?.Value ?? new DimensionChangeOptions();
    ...
    /// Returns the initial Size, this includes the Height and Width of the document.
    /// </summary>
